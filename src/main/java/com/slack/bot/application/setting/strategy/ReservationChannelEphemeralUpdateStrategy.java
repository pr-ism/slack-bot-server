...
public class ReservationChannelEphemeralUpdateStrategy implements SettingUpdateStrategy {

    @Override
    public void apply(NotificationSettings settings, UpdateNotificationSettingsRequest request) {
        settings.updateReservationChannelEphemeral(request.reservationChannelEphemeralEnabled());
    }
}
