...
CREATE TABLE IF NOT EXISTS slack_notification_outbox (
    ...
    team_id VARCHAR(255) NOT NULL,
    channel_id VARCHAR(255) NOT NULL,
    user_id_state VARCHAR(20) NOT NULL,
    user_id VARCHAR(255) NOT NULL,
    text_state VARCHAR(20) NOT NULL,
    text CLOB NOT NULL,
    blocks_json_state VARCHAR(20) NOT NULL,
    blocks_json CLOB NOT NULL,
    fallback_text_state VARCHAR(20) NOT NULL,
    fallback_text VARCHAR(500) NOT NULL,
    status VARCHAR(20) NOT NULL,
    processing_attempt INT NOT NULL,
    processing_lease_state VARCHAR(20) NOT NULL,
    processing_started_at TIMESTAMP(6),
    sent_time_state VARCHAR(20) NOT NULL,
    sent_at TIMESTAMP(6),
    failed_time_state VARCHAR(20) NOT NULL,
    failed_at TIMESTAMP(6),
    failure_state VARCHAR(20) NOT NULL,
    failure_reason VARCHAR(500),
    failure_type VARCHAR(40),
...
CREATE TABLE IF NOT EXISTS review_notification_outbox (
    ...
    team_id VARCHAR(255) NOT NULL,
    channel_id VARCHAR(255) NOT NULL,
    payload_json_state VARCHAR(20) NOT NULL,
    payload_json CLOB NOT NULL,
    blocks_json_state VARCHAR(20) NOT NULL,
    blocks_json CLOB NOT NULL,
    attachments_json_state VARCHAR(20) NOT NULL,
